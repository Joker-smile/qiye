<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"D:\phpStudy\WWW\qiye\public/../application/admin\view\admin\edit.html";i:1492478698;s:72:"D:\phpStudy\WWW\qiye\public/../application/admin\view\public\header.html";i:1493117331;s:70:"D:\phpStudy\WWW\qiye\public/../application/admin\view\public\left.html";i:1491877479;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
    <title></title>
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="<?php echo url('Index/index'); ?>">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo url('edit'); ?>">管理员管理</a>
                    </li>
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    ...
                    <!-- 获取要修改的哪条信息的id，告诉系统要修改哪一条 -->
                     <input type="hidden" name="id" value="<?php echo $admin['id']; ?>">
                      <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">所属管理员组</label>
                            <div class="col-sm-6">
                                ...
                                <option <?php if($authGroups['id'] == $groupId): ?>selected="selected"<?php endif; ?> value="<?php echo $authGroups['id']; ?>"><?php echo $authGroups['title']; ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="username" placeholder="" name="username" value="<?php echo $admin['username']; ?>"  type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
